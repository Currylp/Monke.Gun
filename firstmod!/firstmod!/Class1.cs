...
namespace NoTagLag
{
    [BepInPlugin("org.Chubs.monkeytag.notaglag", "BE GONE TAGLAG!", "1.0.0")]
    public class MyMenuPatcher : BaseUnityPlugin
    {
        public void Awake()
        {
            var harmony = new Harmony("com.Chubs.monkeytag.notaglag");
